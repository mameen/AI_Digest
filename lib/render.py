...
from lib.paths import SKILL_SCRIPTS, cache_dir, diagnostics_dir, reports_dir
from lib.report_source import detect_context_from_reports_dir, detect_source_from_cfg, stamp_document
from lib.frame_author import inject_author_card, sync_author_assets
from lib.frame_nav import diagnostics_available as has_diagnostics
from lib.frame_nav import admin_nav_enabled, inject_frame_nav
...
def rebuild_reports_archive(cfg: dict[str, Any] | None = None, reports: Path | None = None) -> Path:
    ...
    from lib.frame_html import assert_archive_html_ready
