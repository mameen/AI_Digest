...
from lib.history import format_prior_context
from lib.diagnostics import get_collector, instrumented_llm_call, log
from lib.visualize import compute_visualizations, fill_skeleton_stories
...
def _run_link_tool_loop(
    ...
    *,
    ...
    """
    from lib.llm_client import make_raw_chat
...
def _ensure_scripts_path() -> None:
    from lib.paths import SKILL_SCRIPTS
    import sys
